...
//			return "글쓰기" + board;
	...
	public ResponseEntity<?> modify(@PathVariable int boardNo, @RequestBody Board board)
								throws ModifyException, FindException {
...
//			return "글삭제" + boardNo;
	...
	public ResponseEntity<?> modifyReply(@PathVariable int replyNo,
										 @RequestBody Reply reply) throws ModifyException, FindException {
//		System.out.println(replyNo);
	...
	public ResponseEntity<?> removeReply(@PathVariable int replyNo) throws RemoveException, FindException {
//		System.out.println(replyNo);
